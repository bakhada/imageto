...
export const TOOLS: ToolMetadata[] = [
  ...
  },
  {
    ...
    title: 'PNG to SVG (Vector)',
    h1: 'PNG to SVG Vectorizer — Professional Local Conversion',
    metaTitle: 'PNG to SVG Converter | Vectorize Images Privately Online',
    metaDescription: 'Convert raster PNG images to scalable SVG vectors. High-precision local edge detection and path generation.',
    description: 'Transform pixel-based images into infinitely scalable SVG vectors using local browser-side path optimization.',
    defaultFormat: 'image/svg+xml',
    initialOptions: { format: 'image/svg+xml' }
  },
  {
    id: 'compress-image',
